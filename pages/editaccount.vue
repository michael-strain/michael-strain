  ...
  <body>
    <section class="min-h-screen flex items-stretch text-white ">
      ...
      >
        ...
        <!--MAYBE ADD HEADER INFO IN ABSOLUTE TOP HERE-->
        <div class="w-full px-24 z-10">
          <h1 class="textTitle">
            Strain Development
          </h1>
          <!-- <p class="textTitleSub">
            Subtitle
          </p> -->
        </div>
        <!--MAYBE ADD FOOTER INFO IN ABSOLUTE BOTTOM HERE-->
      </div>
      ...
      >
        ...
        <div class="w-full py-6 z-20">
          <!--PAGE TITLE-->
          <h1 class="textTitlePage">
            Log Into Your Account
          </h1>
          
          <div class="text-center text-lg hover-underline-animation">
          ...
          >
            ...
            <div class="text-right">
              <a class="hover-underline-animation" href="#">Forgot Your password?</a>
              <br>
              <a class="hover-underline-animation" href="#">Create New User</a>
            </div>
            <!--SIGN IN BUTTON-->
...
/* uppercase block bg-indigo-500 hover:bg-indigo-600 focus:outline-none */
.formBtn {
  ...
  background: linear-gradient(0deg, rgb(69, 93, 22) 10%, olivedrab 100%);
...
<!--ICONS POSITIONED ABSOLUTE ON BOTTOM-->
