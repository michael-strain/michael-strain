          ...
          <v-card class="absolute h-full opacity-70 bg-black">
            <div class="pt-50">
              ...
              <div class="py-4 pr-8 pl-4 bg-slate-400">
                ...
                <NuxtLink to="/donate">
                  <v-btn block class="m-2 btnc4">
                    <v-icon start icon="mdi-charity" />Donate<v-icon end icon="mdi-charity" />
                  </v-btn>
                </NuxtLink>
              </div>
            </div>
    ...
    <v-card>
      <div class="flex items-center self-stretch">
          ...
          <svg ref="mySVG" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 106.7" style="enable-background:new 0 0 122.88 106.7" xml:space="preserve">
            <g>
              ...
              <path
                ...
                class="st0 path svgplant stroke-cap-round stroke-join-round"
                stroke="#22c55e"
                fill="none"
                stroke-width="3"
        ...
        <div class="w-3/5 float-left text-center items-center">
          <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl filter hue-rotate-60" :style="{ fontFamily: 'Nabla' }">
            Bienvenidos
          </h1>
