...
<template>
  <v-container>
    ...
    <v-card>
      <div class="flex items-center self-stretch">
        ...
        <div class="w-3/5 float-left text-center items-center">
          <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl filter hue-rotate-60" :style="{ fontFamily: 'Nabla' }">Bienvenidos</h1>
    ...
    <v-container class="h-80">
      <v-parallax src="img/bright-red-unusual-flower.jpg" lazy-src="https://picsum.photos/id/11/100/60">
        <div class="flex h-full">
          <div class="w-3/4 sm:w-2/3 md:w-1/2 d-flex flex-column fill-height justify-center text-center align-center text-white font-bold">
            <v-card class="opacity-70 bg-black">
              <h1 class="text-h4 sm:text-h3 mb-4 tracking-widest font-serif">Welcome</h1>
              <h4 class="subheading drop-shadow-2xl">
                The site may have my name on it<br>
                But the purpose is far greater than one individual
              </h4>
            </v-card>
          </div>
          <!-- <v-img class="opacity-0 sm:opacity-100 max-h-60" src="/img/taste-the-rainbow.jpg" /> -->
        </div>
      </v-parallax>
    </v-container>
    ...
    <div class="p-2">
      <NuxtLink to="/services"><v-btn block class="m-2 btnc1"><v-icon start icon="mdi-room-service-outline" />Services<v-icon end icon="mdi-room-service-outline" /></v-btn></NuxtLink>
      <NuxtLink to="/shop"><v-btn block class="m-2 btnc2"><v-icon start icon="mdi-store" />Shop<v-icon end icon="mdi-store" /></v-btn></NuxtLink>
      <NuxtLink to="/invest"><v-btn block class="m-2 btnc3"><v-icon start icon="mdi-chart-areaspline" />Invest<v-icon end icon="mdi-chart-areaspline" /></v-btn></NuxtLink>
      <NuxtLink to="/donate"><v-btn block class="m-2 btnc4"><v-icon start icon="mdi-charity" />Donate<v-icon end icon="mdi-charity" /></v-btn></NuxtLink>
    </div>
    ...
    Donations will be used to feed, shelter, and provide basic necessities for poverty stricken people.
    A single dollar can feed someone a good meal.  $20 can cover medical expenses.  Anything you can give will be greatly appreciated, and when you donate, I'll actually send you pictures of the people I'm giving your donations to, so you can see the difference you are making.
    Times are tough in the US, I understand if you can't give today, but in the very least I hope you follow along and give what you can, when you can - whether it's a donation, a purchase, or even contributing your own time and efforts, all will be welcome.

    The site may have my name on it, but I am dedicating myself to making a much needed positive impact on the community I've chosen to call home.
    <p>Right here should be a blog/vlog video</p>
    <p>Below the blog should be guides/classes in cards arranged as two columns</p>
    <p>E-mail subcsription bar</p>
    <!-- </v-card-title> -->
    <!-- <v-card class="p-5 m-5 h-auto flex justify-center items-center text-center">
      <div class="flex text-center items-center justify-center"><p>Dash Offset should be set to: {{ strokeoff }}</p></div>
    </v-card>
    <v-card class="p-5 m-5 h-44 flex justify-center items-center text-center">
      <div><p>Hi<br></p></div>
    </v-card> -->
  </v-container>
</template>
...
<script>
  export default {
    ...
    mounted() {
      // this.$path = document.getElementById('myLine'),
      // this.$length = document.getElementById('myLine').getTotalLength(),
...
/* @keyframes dash {
  ...
  to {
    stroke-dashoffset: 1245.2255859375;
  }
} */
</style>